/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d8a6eed4a1bf521a8c30f5b4ff1c979)
// Runtime types generated with workerd@1.20260508.1 2026-05-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/worker/src/index");
		durableNamespaces: "InfernoRoom";
	}
	interface Env {
		INFERNO_DB: D1Database;
		FEEDBACK_FROM: "InfernoDrift4 <feedback@infernodrift.local>";
		FEEDBACK_TO: "clarkbythebay@gmail.com,clark.alden@lbusd.org";
		INFERNO_ROOM: DurableObjectNamespace<import("./apps/worker/src/index").InfernoRoom>;
	}
}
