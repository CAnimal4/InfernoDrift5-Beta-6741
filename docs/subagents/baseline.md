...
React/Vite work from earlier passes is historical reference only until it passes a future parity gate. Do not describe it as the active launch architecture.
